...
static int gmac_ma35h0_ofdata_to_platdata(struct udevice *dev)
{
	struct gmac_ma35h0_platdata *pdata = dev_get_platdata(dev);
...
static int gmac_ma35h0_probe(struct udevice *dev)
{
	struct gmac_ma35h0_platdata *pdata = dev_get_platdata(dev);
...
const struct eth_ops gmac_ma35h0_eth_ops = {
...
static const struct udevice_id ma35h0_gmac_ids[] = {
	{ .compatible = "nuvoton,ma35h0-gmac" },
	{ }
};

U_BOOT_DRIVER(eth_gmac_ma35h0) = {
	.name	= "gmac_ma35h0",
	.id	= UCLASS_ETH,
	.of_match = ma35h0_gmac_ids,
	.ofdata_to_platdata = gmac_ma35h0_ofdata_to_platdata,
	.probe	= gmac_ma35h0_probe,
	.ops	= &gmac_ma35h0_eth_ops,
	.priv_auto_alloc_size = sizeof(struct dw_eth_dev),
	.platdata_auto_alloc_size = sizeof(struct gmac_ma35h0_platdata),
