...
#ifndef _MA35D0_SPI_H_
#define _MA35D0_SPI_H_

#if defined(CONFIG_USE_MA35D0_QSPI0)
#define SPI_BASE 0x40680000 //QSPI0
#elif defined(CONFIG_USE_MA35D0_QSPI1)
#define SPI_BASE 0x40690000 //QSPI1
#elif defined(CONFIG_USE_MA35D0_SPI0)
#define SPI_BASE 0x40600000 //SPI0
#elif defined(CONFIG_USE_MA35D0_SPI1)
#define SPI_BASE 0x40610000 //SPI1
#elif defined(CONFIG_USE_MA35D0_SPI2)
#define SPI_BASE 0x40620000 //SPI2
#elif defined(CONFIG_USE_MA35D0_SPI3)
...
struct ma35d0_spi_slave {
	struct spi_slave slave;
	unsigned int max_hz;
	unsigned int mode;
};

static inline struct ma35d0_spi_slave *to_ma35d0_spi(struct spi_slave *slave) {
	return container_of(slave, struct ma35d0_spi_slave, slave);
}

#endif //_MA35D0_SPI_H_
