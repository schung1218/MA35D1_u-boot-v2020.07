...
#ifndef __DRIVERS_CLK_NUVOTON_CLK_MA35D0_H
#define __DRIVERS_CLK_NUVOTON_CLK_MA35D0_H
...
struct __ma35d0_clk_sel_type_map {
	u32 muxMap[4];
};

struct __ma35d0_clk_gate_data {
	u32 type;
	ulong rate;
	u32 offst;
	u32 bitIdx;
...
struct ___ma35d0_clk_reg_info {
	struct __ma35d0_clk_gate_data clkGate;
	struct __ma35d0_clk_mux_data  clkMux;
	struct __ma35d0_clk_div_data  clkDiv;
};


enum ma35d0_pll_type {
	MA35D0_CAPLL,
	MA35D0_DDRPLL,
	MA35D0_APLL,
	MA35D0_EPLL,
...
enum ma35d0_pll_mode {
	VSIPLL_INTEGER_MODE,
	VSIPLL_FRACTIONAL_MODE,
	VSIPLL_SS_MODE,
};

struct __ma35d0_pll_data {
	u8 type;
	u8 mode;
	unsigned long rate;
	u8 ctl0;
...
static struct __ma35d0_clk_sel_type_map __clk_sel_type_tbl[] = {
...
static struct __ma35d0_pll_data __ma35d0_capll_data = {
	.type = 0,
	.ctl0= REG_CLK_PLL0CTL0,
};


static struct __ma35d0_pll_data __ma35d0_ddrpll_data = {
	.type = 1,
...
static struct __ma35d0_pll_data __ma35d0_apll_data = {
	.type = 2,
...
static struct __ma35d0_pll_data __ma35d0_epll_data = {
	.type = 3,
...
static struct __ma35d0_pll_data __ma35d0_vpll_data = {
	.type = 4,
...
static struct __ma35d0_clk_gate_data __clk_id_gate_sets[] = {
...
static struct __ma35d0_clk_mux_data __clk_id_mux_sets[] = {
...
static struct __ma35d0_clk_div_data __clk_id_div_sets[] = {
